...
var ed2kls={exd:{},shk:{},retry:{},bytes:{},tb:{},gb:{},mb:{},kb:{}};
//]]></script>
...
';
		...
		function shortcodeEd2k( $atts = array(), $content = NULL, $code ) {
			...
			$newcontent = '
<script type="text/javascript">//<![CDATA[
ed2kls.retry["' . $myno . '"]="' . __('Loading not finished. Please retry.', 'ed2kls') . '";
ed2kls.shk["' . $myno . '"]="' . __('Shrink', 'ed2kls') . '";
ed2kls.exd["' . $myno . '"]="' . __('Expand', 'ed2kls') . '";
ed2kls.bytes["' . $myno . '"]="' . __('Bytes', 'ed2kls') . '";
ed2kls.tb["' . $myno . '"]="' . __('TB', 'ed2kls') . '";
ed2kls.gb["' . $myno . '"]="' . __('GB', 'ed2kls') . '";
ed2kls.mb["' . $myno . '"]="' . __('MB', 'ed2kls') . '";
ed2kls.kb["' . $myno . '"]="' . __('KB', 'ed2kls') . '";
//]]></script>
...
<tr class="el-s-tr' . $odd . '">
	<td class="el-s-left">
		<input type="checkbox" class="el-s-chkbx el-s-chkbx-ed2k" name="el-s-chkbx-' . $myno . '" id="el-s-chkbx-' . $myno . '-' . $num . '" value="' . $url . '" onclick="els.checkIt(\'' . $myno . '\',event);" checked="checked" /><a class="el-s-dl" href="' . $url . '" ed2k="' . $url . '">' . $name . '</a>';
