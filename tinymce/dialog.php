...
<head>
<title><?php echo __('Add eD2k Links', 'ed2kls') ?></title>
...
<body style="display: none">
	<div id="wrapper">
		<div id="noteline" class="elsdiv">
			<label for="ed2klsTa"><?php echo __('Enter your eD2k links and intros:', 'ed2kls') ?></label>
		</div>
		<div id="taline" class="elsdiv">
			<textarea rows="20" cols="85" class="" id="ed2klsTa"></textarea>
		</div>
		<div id="buttonsline" class="elsdiv">
			<input type="button" value="<?php echo __('OK', 'ed2kls') ?>" id="ok" class="mceButton" onclick="ed2klsDialog.add(document.getElementById('ed2klsTa').value);">
			<input type="button" value="<?php echo __('Clean', 'ed2kls') ?>" id="clean" class="mceButton" onclick="document.getElementById('ed2klsTa').value=ed2klsDialog.clean(document.getElementById('ed2klsTa').value,'\n');">
			<input type="button" value="<?php echo __('Cancel', 'ed2kls') ?>" id="cancel" class="mceButton" onclick="ed2klsDialog.cancel();">
		</div>
	</div>
</body>
</html>
